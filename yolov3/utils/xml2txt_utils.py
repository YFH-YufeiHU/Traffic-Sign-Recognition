...
os.chdir(os.path.dirname(os.path.abspath(__file__)))#os.chdir() 方法用于改变当前工作目录到指定的路径

# change directory to the one with the files to be changed
parent_path = os.path.abspath(os.path.join(os.getcwd(), os.pardir))
parent_path = os.path.abspath(os.path.join(parent_path, os.pardir))
GT_PATH = os.path.join(parent_path, 'Keras-yolo3-master','utils','xml')
print(GT_PATH)
os.chdir(GT_PATH)#os.chdir() 方法用于改变当前工作目录到指定的路
